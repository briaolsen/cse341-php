...
<body id="search-body">
  ...
  <table class="table table-striped">
    ...
    $statement = $db->prepare('SELECT book.title, book.lexile, book.genre, author.first_name, author.middle_name, author.last_name, series.series_name FROM book OUTER JOIN author ON book.author_id = author.id OUTER JOIN series ON author.id = series.author_id');
    $statement->execute();
